...
<div class="container-fluid" id="main">
	...
	<div class="row">
		<div class="col-12 d-flex justify-content-between align-items-center mb-4">
			<h1 class="h3 text-gray-800">Editar categoría de objeto <b><?= $objecttaxonomies->objectTaxonomyName ?></b></h1>
			<a href="<?= base_url('backoffice/configuracion/objeto/') . $objecttaxonomies->objectTaxonomySlug ?>" class="btn btn-outline-secondary btn-sm" role="button">Volver</a>
		</div>
