...
<div class="container-fluid" id="main">
	...
	<div class="row">
		<div class="col-12 d-flex justify-content-between align-items-center mb-4">
			<h1 class="h3 text-gray-800">Rol <b><?= $role->_id ?></b></h1>
			<a href="<?= base_url('backoffice/roles') ?>" class="btn btn-outline-secondary btn-sm" role="button">Volver</a>
		</div>
		...
		<div class="col-12">
			...
			<div class="card border-0 mb-3 shadow-sm">
				...
				<p class="px-3 py-2 mt-0 mb-3">
					<a href="<?= base_url('backoffice/role/'. $role->_id .'/editar') ?>" class="btn btn-outline-warning btn-block" role="button">Editar</a>
				</p>
			</div>
