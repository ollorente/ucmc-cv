...
class Examples extends MY_Controller
{
	...
	public function index()
	{
		if( $this->require_min_level(6) )
		{
			...
			echo $this->load->view('backoffice/templates/header', $data);
			echo $this->load->view('backoffice/dashboard', $data);
			echo $this->load->view('backoffice/templates/footer', $data);
        }
	}
	 ...
	 * If they are not logged in, a link to "Examples" will be in the menu.
	 */
	...
	public function ajax_attempt_login()
	{
		if( $this->input->is_ajax_request() )
		{
			...
			// Examples attempt was successful
			if( $this->auth_data )
			{
				echo json_encode([
					'status'   => 1,
			...
			// Examples attempt not successful
			else
			{
				$this->tokens->name = config_item('login_token_name');
