        ...
        <div class="container-fluid" id="main">
          ...
          <div class="row">
            <div class="col-12 d-flex justify-content-between align-items-center mb-4">
              ...
              <a href="<?= base_url('backoffice/diplomados/nuevo') ?>" class="btn btn-outline-primary btn-sm" role="button">Nuevo</a>
            </div>
            ...
            <div class="col-12">
              ...
              <div class="d-flex justify-content-between border-bottom">
                <div class="d-flex flex-row">
                  ...
                  <a href="<?= base_url('backoffice/diplomado/') . $item['_id'] ?>" class="m-2 text-left"><?= $item['graduateName'] ?></a>                
                </div>
                <div class="m-2 text-right">
                <div class="custom-control custom-switch">
                  <input type="checkbox" class="custom-control-input" id="index<?= $item['_id'] ?>" checked="<?php if ($item['isGraduateActive'] === '1') { echo 'checked'; } else { echo ''; } ?>">
            ...
            <div class="col-12 my-4 text-center">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <?php if ($currentpage == 2) { ?>
                        <a href="<?= base_url('backoffice/diplomados') ?>" type="button" class="btn btn--azul">Atrás</a>
                    <?php } else { ?>
                        <?php if ($currentpage == 1) { ?>
                            <a href="#" type="button" class="btn btn--azul disabled">Atrás</a>
                        <?php } else { ?>
                            <a href="<?= base_url('backoffice/diplomados') ?>/p/<?= $currentpage - 1 ?>" type="button" class="btn btn--azul">Atrás</a>
                        <?php } ?>
                    <?php } ?>
                    <a href="#" type="button" class="btn btn--azul disabled"><?= $currentpage ?></a>
                    <?php if ($currentpage < $lastpage) { ?>
                    <a href="<?= base_url('backoffice/diplomados') ?>/p/<?= $currentpage + 1 ?>" type="button" class="btn btn--azul">Siguiente</a>
                    <?php } ?>
                    <?php if ($currentpage >= $lastpage) { ?>
